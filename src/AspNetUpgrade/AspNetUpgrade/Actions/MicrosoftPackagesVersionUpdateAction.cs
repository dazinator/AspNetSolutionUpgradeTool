...
{
    public class MicrosoftPackagesVersionUpdateAction : BaseDependenciesUpdateAction
    {
        ...
        public MicrosoftPackagesVersionUpdateAction() : base(DependencyPredicate, UpdateDependencyCallback)
        {
