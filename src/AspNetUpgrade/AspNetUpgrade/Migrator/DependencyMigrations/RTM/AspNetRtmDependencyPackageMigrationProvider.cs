...
{
    public class AspNetRtmDependencyPackageMigrationProvider : IDependencyPackageMigrationProvider
    {
        public List<DependencyPackageMigrationInfo> GetPackageMigrations(ToolingVersion targetToolingVersion, IProjectUpgradeContext projectContext)
        {
            ...
            // aspnet packages
            var package = new DependencyPackageMigrationInfo("Microsoft.AspNetCore.Identity.EntityFrameworkCore", releaseVersion);
            package.OldNames.Add("Microsoft.AspNet.Identity.EntityFramework");
            list.Add(package);

            package = new DependencyPackageMigrationInfo("Microsoft.AspNetCore.Server.IISIntegration", releaseVersion);
            package.OldNames.Add("Microsoft.AspNet.IISPlatformHandler");
            list.Add(package);

            package = new DependencyPackageMigrationInfo("Microsoft.AspNetCore.Diagnostics.EntityFrameworkCore", releaseVersion);
            ...
            if (projectWrapper.IsMvcProject())
            {
                ...
                package = new DependencyPackageMigrationInfo("Microsoft.AspNetCore.Diagnostics", releaseVersion);
            ...
            package = new DependencyPackageMigrationInfo("Microsoft.ApplicationInsights.AspNetCore", releaseVersion);
