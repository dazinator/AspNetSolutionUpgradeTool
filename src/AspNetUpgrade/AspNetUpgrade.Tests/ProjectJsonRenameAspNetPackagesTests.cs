...
namespace AspNetUpgrade.Tests
{
    ...
    [TestFixture]
    public class ProjectJsonRenameAspNetPackagesTests
    {

        public ProjectJsonRenameAspNetPackagesTests()
        {
        ...
        public void Can_Apply(string scenario, string json)
        {
            ...
            using (ApprovalResults.ForScenario(scenario))
            {
                ...
                var sut = new AspNetUpgrade.Actions.RenameAspNetPackagesAction();
