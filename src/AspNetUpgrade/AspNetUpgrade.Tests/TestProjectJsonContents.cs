...
";
        ...
        public const string GluonCoreLibraryProject = @"{
  'version': '1.0.0-*',
  ...
  'scripts': {
    ...
    'postpack': [ 'copy /y \'%project:Directory%\\..\\..\\artifacts\\bin\\%project:Name%\\%build:Configuration%\\%project:Name%.%project:Version%.symbols.nupkg\' \'%project:Directory%\\..\\..\\artifacts\\bin\\Libraries\\%project:Name%.%project:Version%.nupkg' ]
  }
}
";
